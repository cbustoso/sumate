...
var KTDatatablesServerSide = function () {
    ...
    var initDatatable = function () {
        dt = $("#kt_generic_datatable").DataTable({
            ...
            ajax: {
                url: "/api/v1/general/report/users/expired/points/",
                data: function (d) {
                    d.semester = semester;
                },
            },
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                        <td class="text-end pe-0">
                            <p class="font-size-sm font-weight-bolder">${row.total_points}</p>
                        </td>
                        `;
                    }
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                        <td class="text-end pe-0">
                            <p class="font-size-sm font-weight-bolder">${row.created_at}</p>
                        </td>
                        `;
                    }
                },
    ...
    var exportButtons = () => {
        ...
        const documentTitle = 'reporte_puntos_expirados' + formattedDate;
