...
var KTDatatablesServerSide = function () {
    ...
    var initDatatable = function () {
        dt = $("#kt_generic_datatable").DataTable({
            ...
            ajax: {
                url: "/api/v1/general/report/participation/events-types/",
                data: function (d) {
                    d.semester = semester;
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <td class="text-end pe-0">
                            <p class="font-size-sm font-weight-bolder">${row.event_type}</p>
                        </td>
                        `;
                    }
                },
    ...
    var exportButtons = () => {
        ...
        const documentTitle = 'reporte_general_tipo_evento_' + formattedDate;
